...
def choose():
    ...
    while True:
        choice = input('"c" for checking total inventory value, "a" for adding an item: ').lower()[0]
...
def select_inventory(inventory):
    ...
    while True:
        ...
        select = input('What product would you like to check? Please enter the product id:  ')
        ...
        if len(select) != 3:
            ...
            print(f'The value of the product {select} is {product_value} dollars.')
            break
